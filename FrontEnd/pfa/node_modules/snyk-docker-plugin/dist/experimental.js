...
async function distroless(targetImage, dockerfileAnalysis, options) {
    ...
    const archiveResult = await image_inspector_1.getImageArchive(targetImage, imageSavePath, (_b = options) === null || _b === void 0 ? void 0 : _b.username, (_c = options) === null || _c === void 0 ? void 0 : _c.password);
    try {
